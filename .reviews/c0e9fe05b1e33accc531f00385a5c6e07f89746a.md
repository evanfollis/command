# Review: c0e9fe0 — Pin prompteval harness to reviewed retry-hardening commit
...
`HARNESS_REVISION`, `HARNESS_LIBRARY_TREE`, `HARNESS_ENTRY_BLOB` updated in `run-release-eval.sh`. No logic changes.
