# Review: cd1f65e — Document unattributed throttle bucket as known Cloudflare-deployment gap
...
8-line documentation comment added to `loginThrottle.ts`. No logic changes. Correctly documents the intended Cloudflare-backed deployment context and owner recovery path (wait 5 minutes or restart service). No blocking defect.
