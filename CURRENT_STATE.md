...
**Last updated**: 2026-07-12T20:16Z — **ADR-0046 owner observatory live and verified**. The consumer validates the exact Synaplex public v1 snake_case contract and declared canonical digest. It reports only typed `research` / `findings` / `mechanisms` counts and explicit Decision/Evidence provenance; Claims, frozen gates, invariants, pod reuse, owner authority, handoff pressure, and public/private coherence remain `unknown` until typed sources exist. Unrelated CURRENT_STATE/handoff movement is never projection drift. Next/React is on the patched 15.5.18/19.1.7 line. Local and public authenticated Chromium passed desktop/mobile observatory, attach, artifact, and zero-JS-error coverage; artifacts: `runtime/browser-smoke/2026-07-12T20-15-01/` and `runtime/browser-smoke/2026-07-12T20-15-07/`. ADR-0039 prompt-eval work remains **preserved uncommitted and NOT trustworthy** — none of its contaminated baselines are acceptance evidence.
