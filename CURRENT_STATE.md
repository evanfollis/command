...
**Last updated:** 2026-07-20T00:45Z — thread-opening run `996c20` exposed a diagnostic-judge category error; the active contract is clarified and one accidentally surfaced sealed record was retired/resealed. No external eval or deployment run here.
