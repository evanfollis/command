...
**Last updated**: 2026-07-12T20:19Z — **ADR-0046 owner observatory live with corrected domain-health derivation**. The consumer validates the exact Synaplex public v1 snake_case contract and declared canonical digest. Projection integrity remains distinct from domain health: typed research status/block aggregates drive Research and overall posture, so the current `opposing-review-unavailable` block is visible as `blocked`; Findings and Mechanisms are explicitly count/integrity signals, not progress claims. Claims, frozen gates, invariants, pod reuse, owner authority, handoff pressure, and public/private coherence remain `unknown` until typed sources exist. Unrelated CURRENT_STATE/handoff movement is never projection drift. Next/React is on the patched 15.5.18/19.1.7 line. ADR-0039 prompt-eval work remains **preserved uncommitted and NOT trustworthy** — none of its contaminated baselines are acceptance evidence.
