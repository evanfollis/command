...
- For release or rollback safety diagnoses, trace dependency and lock identity, runtime and service configuration, the actual readiness target, rollback selection and recovery verification, and the regression coverage before giving a no-defect conclusion.
